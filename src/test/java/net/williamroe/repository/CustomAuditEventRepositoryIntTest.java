package net.williamroe.repository;

import net.williamroe.RfbloyaltyApp;
import net.williamroe.config.Constants;
import net.williamroe.config.audit.AuditEventConverter;
import net.williamroe.domain.PersistentAuditEvent;
...
import static net.williamroe.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
