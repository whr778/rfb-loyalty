package net.williamroe.web.rest;

import net.williamroe.config.Constants;
import net.williamroe.RfbloyaltyApp;
import net.williamroe.domain.Authority;
import net.williamroe.domain.PersistentToken;
import net.williamroe.domain.User;
import net.williamroe.repository.AuthorityRepository;
import net.williamroe.repository.PersistentTokenRepository;
import net.williamroe.repository.UserRepository;
import net.williamroe.security.AuthoritiesConstants;
import net.williamroe.service.MailService;
import net.williamroe.service.dto.UserDTO;
import net.williamroe.web.rest.errors.ExceptionTranslator;
import net.williamroe.web.rest.vm.KeyAndPasswordVM;
import net.williamroe.web.rest.vm.ManagedUserVM;
import net.williamroe.service.UserService;
