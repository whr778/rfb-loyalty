package net.williamroe.config.social;

import net.williamroe.repository.SocialUserConnectionRepository;
import net.williamroe.repository.CustomSocialUsersConnectionRepository;
import net.williamroe.security.social.CustomSignInAdapter;
